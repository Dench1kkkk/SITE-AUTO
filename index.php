    ...
    <main>
        <section class="blok">
            ...
            <div class="blok-dada">
                ...
                <div class="b-1"><h3>ОПЛАТА 60/40</h3><p>60% вы оплачиваете во время заключения договора, остаток при получении</p></div>
        ...
        <section class="blok-3">
            ...
            <div class="vse">
                <div class="border">
                    <div>
                        <div><img src="assets/papa/Rectangle 9.png" alt=""></div>
                        <div class="centrovka">
                            <h1 class="magaz">Автомобиль продан</h1>
                        </div>
                        <h1 class="avtoo">Audi Q5 (FY), 2022</h1>
                        <div class="b3-1">
                            <div>Конфигурация 40 TDI Quattro</div>
                            <div>Коробка передач АКПП</div>
                            <div>Тип топлива Дизель</div>
                        </div>
                        <div class="dada">
                            <p class="cena">Цена в городе Санкт-Петербург</p>
                            <h6 class="money">4 216 309 ₽</h6>
                        </div>
                    </div>
                </div>
                <div class="border">
